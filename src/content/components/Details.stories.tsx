...
export const WithImages: Story = {
  args: {
    ...
    description: DESCRIPTION,
    media: [
      { type: 'image', url: 'https://picsum.photos/seed/cinema1/640/360', alt: 'Vienna street scene' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema2/640/360', alt: 'Night pursuit sequence' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema3/640/360', alt: 'Harry Lime in shadows' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema4/640/360', alt: 'The Ferris wheel scene' },
    ],
  },
}
...
export const WithVideos: Story = {
  args: {
    ...
    description: DESCRIPTION,
    media: [
      { type: 'video', url: 'https://www.w3schools.com/html/mov_bbb.mp4', title: 'Original Trailer' },
      { type: 'video', url: 'https://www.w3schools.com/html/movie.mp4', title: 'Director Interview' },
    ],
  },
}
...
export const MixedMedia: Story = {
  args: {
    ...
    description: DESCRIPTION,
    media: [
      { type: 'image', url: 'https://picsum.photos/seed/cinema1/640/360', alt: 'Vienna 1949' },
      { type: 'video', url: 'https://www.w3schools.com/html/mov_bbb.mp4', title: 'Theatrical Trailer' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema3/640/360', alt: 'Film noir lighting' },
      { type: 'video', url: 'https://www.w3schools.com/html/movie.mp4', title: 'Score Recording' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema5/640/360', alt: 'Behind the scenes' },
    ],
  },
}
...
export const NoTitle: Story = {
  args: {
    description: DESCRIPTION,
    media: [
      { type: 'image', url: 'https://picsum.photos/seed/cinema1/640/360', alt: 'Film still' },
      { type: 'image', url: 'https://picsum.photos/seed/cinema2/640/360', alt: 'Film still' },
    ],
  },
}
...
export const WithTimestampsAndTags: Story = {
  args: {
    ...
    tags: ['film noir', 'post-war', 'orson welles', 'vienna', '1949', 'criterion'],
  },
}
...
export const TagsOnly: Story = {
  args: {
    title: 'The Third Man',
    description: DESCRIPTION,
    tags: ['film noir', 'post-war', 'orson welles', 'vienna', '1949', 'criterion', 'british cinema', 'expressionism'],
  },
}
